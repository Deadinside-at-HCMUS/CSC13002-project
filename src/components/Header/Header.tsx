        ...
        <div className="bg-white h-16 px-4 flex items-center border-b border-gray-200 justify-between">
            ...
            <div className="flex items-center gap-2 mr-2">
                        ...
                        <>
                            <Popover.Button
                                className={classNames(
                                    open && 'bg-gray-100',
                                    'group inline-flex items-center rounded-md p-1.5 text-gray-700 hover:text-opacity-100 focus:outline-none active:bg-gray-100'
                                )}
                            >
                ...
                <div className="items-center text-gray-500">
                    <span className="text-[15px]">Hi, {username}</span>
                </div>
